...
<!-- site main header end  -->
  ...
  <section class="products-by-category">
    <div class="products-by-category-inner container">
      <div class="category-page-filters-bar d-flex-aic-jcsb">
        <?php
          if(isset($_GET['category']) && ! $_REQUEST['category']=='' ){  
            $category_id = $_GET['category'];
            $select_products = "Select * from  `products` where category = $category_id ";
            ...
            $search_query = "
              Select * from  `products` where category = $category_id  && price > $min_price_value && price < $max_price_value ";
          ...
          <?php
            ...
            $result_category = mysqli_query($conn, $select_categories);
            while($row_data = mysqli_fetch_assoc($result_category)){
              $category_name = $row_data['category_name'];
              $cat_id = $row_data['_id'];
              ?>
              <li <?php if($cat_id == $category_id){ echo "style='background: #bd8448'";} ?> >
      ...
      <div class="product-cards-area container caregory-cards-carea">
        <?php 
